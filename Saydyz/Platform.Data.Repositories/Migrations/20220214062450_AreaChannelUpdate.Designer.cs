...
namespace Platform.Data.Repositories.Migrations
{
    ...
    [Migration("20220214062450_AreaChannelUpdate")]
    partial class AreaChannelUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Platform.Data.Model.Order.Channel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Platform.Data.Model.Order.Customer.Area", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Platform.Data.Model.Customer.Customer", b =>
                {
                    b.HasOne("Platform.Data.Model.Order.Customer.Area", "Area")
                        .WithMany()
            ...
            modelBuilder.Entity("Platform.Data.Model.Order.Order", b =>
                {
                    b.HasOne("Platform.Data.Model.Order.Channel", "Channel")
                        .WithMany()
